...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-05 19:34:05 UTC<br>状态：成功</p>
</section>
...
<p>速读：《Network-Aware Forecasting on Wireless Access Points》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Network-Aware Forecasting on Wireless Access Points">Network-Aware Forecasting on Wireless Access Points</span></li></ul>
  </div>
